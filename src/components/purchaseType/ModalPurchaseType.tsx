...
interface ModalProps {
  isOpen: boolean;
  onClose: () => void;
  onPurchaseTypeAction: () => void;
  isUpdate: boolean;
  purchaseTypeId: string;
}

const ModalPurchaseType: React.FC<ModalProps> = ({ isOpen, onClose, onPurchaseTypeAction, isUpdate, purchaseTypeId }) => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setPurchaseTypeName(e.target.value);
    };
