        ...
        <div>
            <div className="flex items-center mt-5">
                <button 
                    ...
                    onClick={openModal}
                >Novo</button> 
                <h1 className="text-2xl ml-102 mt-5 mr-10 font-semibold text-gray-900 dark:text-white">Tipo de Pagamento</h1> 
            </div>
            ...
            <ModalPaymentType isOpen={isModalOpen} onClose={closeModal} />
        </div>
    )
}
